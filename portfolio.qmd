...
```{=html}
<iframe src="../otros_recursos/analisis_final_2025.html" width="90%" height="400px" style="border:none; margin:1rem 0;"></iframe>
```
...
<div class="contact-links">
  ...
  <a href="../otros_recursos/analisis_final_2025.html" class="contact-link" target="_blank">
...
```{=html}
<iframe src="../otros_recursos/Resumen_Spotify.html" width="90%" height="400px" style="border:none; margin:1rem 0;"></iframe>
```
...
<div class="contact-links">
  ...
  <a href="../otros_recursos/Resumen_Spotify.html" class="contact-link">
...
```{=html}
<iframe src="../otros_recursos/tfg.pdf" width="80%" height="500px" style="border:none;"></iframe>
```

```{=html}
<div class="contact-links">

  <a href="../otros_recursos/tfg.pdf" class="contact-link">
