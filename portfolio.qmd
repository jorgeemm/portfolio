...
[Ver código en GitHub](https://github.com/jorgeemm/Resumen_Spotify){.btn .btn-primary target="_blank"} [Acceder al informe completo](Resumen_Spotify.html){.btn .btn-primary target="_blank"}
...
[Acceso a la página completa](https://jorgemm.quarto.pub/graficos/){.btn .btn-primary target="_blank"}
...
[Acceder al TFG completo](tfg.pdf){.btn .btn-primary target="_blank"}
